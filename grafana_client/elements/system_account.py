...
class SystemAccounts(Base):
    def __init__(self, client):
        super(SystemAccounts, self).__init__(client)
        self.client = client

    # def search_system_accounts(self, query=None, page=None, perpage=None):
    #     """
    ...
    #     list_of_sa = []
    #     sa_on_page = None
    #     show_sa_path = "/org/serviceaccounts"
    #     params = []
...
class SystemAccount(Base):
    def __init__(self, client):
        super(SystemAccount, self).__init__(client)
        self.client = client
        self.path = "/user"
